...
export const KUOTA_JALUR_LIST: KuotaJalur[] = [
  ...
  },
  {
    ...
    syaratUtama: [
      ...
      'Surat tugas orang tua sebagai pendidik/tendik di SMP Darusalah (khusus kuota anak guru).'
    ],
...
export const INITIAL_PESERTA_LIST: PesertaSPMB[] = [
  {
    ...
    alamatKK: 'Jl. Darusalah Gang 2 No. 14, RT 03 / RW 05',
    rtRw: '003/005',
    kelurahan: 'Darusalah',
...
export const FAQ_LIST = [
  {
    ...
    a: 'TIDAK. Pendaftaran SPMB di SMP Darusalah 100% GRATIS dan bebas dari segala bentuk pungutan biaya, sesuai Permendikdasmen No. 3/2025.'
  },
  {
